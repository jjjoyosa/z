...
// Function to start the game on web
function startGame() {
...
// Function to start the game on mobile
...
// Function to check device type and start the game accordingly
function checkDeviceAndStartGame() {
